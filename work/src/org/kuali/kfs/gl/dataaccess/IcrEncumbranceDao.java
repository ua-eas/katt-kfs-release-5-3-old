...
public interface IcrEncumbranceDao {
     ...
     */
    public void buildIcrEncumbranceFeed(Integer fiscalYear, String icrEncumbOriginCode, Collection<String> icrEncumbBalanceTypes, String[] expenseObjectTypes, String costShareSubAccountType, Writer fw) throws IOException;
